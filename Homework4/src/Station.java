...
public class Station {
    ...
    public void passengerEmbarkingFirst(int i) {
        if (currentMin % 5 == 0) {
            ...
            int counter = 0;
            System.out.println("The value of available room: " + Train.getTrainArray()[0].getAvailableRoom());
            for (int k = 0; k < Train.getFirstCapacity(); k++) {
                if (k < availableRoom && k < size) {
            ...
            System.out.println(Train.getTrainArray()[0].getAvailableRoom());
    ...
    public void trainArriving(){
        if(currentMin == 0){
            ...
            System.out.println("Train 1 arrives at Huntington, There are 0 passengers in first class and 0 in second class.\n");
            passengerEmbarkingFirst(1); //dequeue from huntingfirstclass
        ...
        if(currentMin == 5){
            ...
            System.out.println("Trains:\n");
            System.out.println("Train 1 arrives at Syosset, There are 0 passengers in first class and 0 in second class.\n");
            passengerEmbarkingFirst(3); // dequeue from syosset first class
            passengerEmbarkingSecond(2);
            System.out.println("Train 2 arrives at Huntington, There are 0 passengers in first class and 0 in second class.");
        ...
        if(currentMin == 10){
            System.out.println("Trains:\n");
            System.out.println("Train 1 arrives at Hicksville, There are 0 passengers in first class and 0 in second class.\n");
            passengerEmbarkingFirst(5);
            passengerEmbarkingSecond(4);
            System.out.println("Train 2 arrives at Syosset, There are 0 passengers in first class and 0 in second class.");
            passengerEmbarkingFirst(3);
            passengerEmbarkingSecond(2);
            System.out.println("Train 3 arrives at Huntington, There are 0 passengers in first class and 0 in second class");
        ...
        if(currentMin == 15){
            System.out.println("Trains:\n");
            System.out.println("Train 1 arrives at Mineola, There are 0 passengers in first class and 0 in second class.\n");
            passengerEmbarkingFirst(7);
            passengerEmbarkingSecond(6);
            System.out.println("Train 2 arrives at Hicksville, There are 0 passengers in first class and 0 in second class.");
            passengerEmbarkingFirst(5);
            passengerEmbarkingSecond(4);
            System.out.println("Train 3 arrives at Syosset, There are 0 passengers in first class and 0 in second class");
            passengerEmbarkingFirst(3);
            passengerEmbarkingSecond(2);
            System.out.println("Train 4 arrives at Huntington.There are 0 passengers in first class and 0 in second class");
            passengerEmbarkingFirst(1);
            passengerEmbarkingSecond(0);
        }
        if(currentMin == 20){
...
//            passengerEmbarkingSecond();
            System.out.println("Train 2 arrives at Mineola, There are 0 passengers in first class and 0 in second class.");
            passengerEmbarkingFirst(7);
            passengerEmbarkingSecond(6);
            System.out.println("Train 3 arrives at Hicksville, There are 0 passengers in first class and 0 in second class");
            passengerEmbarkingFirst(5);
            passengerEmbarkingSecond(4);
            System.out.println("Train 4 arrives at Syosset.There are 0 passengers in first class and 0 in second class");
            passengerEmbarkingFirst(3);
            passengerEmbarkingSecond(2);
        }
        if(currentMin == 25){
...
//            passengerEmbarkingFirst();
//            passengerEmbarkingSecond();
            System.out.println("Train 3 arrives at Mineola, There are 0 passengers in first class and 0 in second class");
            passengerEmbarkingFirst(7);
            passengerEmbarkingSecond(6);
            System.out.println("Train 4 arrives at Hicksville.There are 0 passengers in first class and 0 in second class");
            passengerEmbarkingFirst(5);
            passengerEmbarkingSecond(4);
        }
        if(currentMin == 30){
...
//            passengerEmbarkingFirst();
//            passengerEmbarkingSecond();
            System.out.println("Train 4 arrives at Mineola.There are 0 passengers in first class and 0 in second class");
            passengerEmbarkingFirst(7);
            passengerEmbarkingSecond(6);
        }
        if (currentMin == 35) {
...
//            passengerEmbarkingSecond(7);
    ...
    public void simulateTimeStep(){
        Train.createTrainInstance();
        for  ( currentMin = 0; currentMin < 16; currentMin = currentMin + 5){
            System.out.println("\nTime: " + currentMin);
